...
## 1️⃣ `core/urls.py` — Routing for Markdown
...
> ✅ **`/markdown/`** renders a static markdown content page.
> ✅ **`/markdown/<filename>/`** handles specific markdown files, dynamically serving them as HTML.

---

## 2️⃣ `core/views.py` — Markdown Rendering Logic
...
## 3️⃣ Template: `markdown_renderer.html`
